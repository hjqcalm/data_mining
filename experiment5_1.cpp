...
//test getEuclidDistance();
	//cout<<getEuclidDistance(transactions[0],transactions[1])<<endl;
	//cout<<getEuclidDistance(transactions[4],transactions[5])<<endl;
...
*/
	...
	do{
		...
		for(int i = 0;i < NUMBER_OF_TRANSACTIONS;i++){
			...
			for(int m = 0;m < K;m++){
				...
				//cout<<"	transactions["<<i<<"] <=> center_point["<<m<<"]:"<<temp_distance<<endl;
				//cout<<"	hjq0_distance:"<<min_distance<<"|"<<temp_distance<<endl;
				if(temp_distance < min_distance){
					min_distance = temp_distance;
					which_class = m;
				}
				//cout<<"	hjq1_min_distance="<<min_distance<<";class="<<which_class<<endl<<endl;
			}
	...
	*/
	...
	/*
		...
		cout<<endl<<"--------------------------------------------------------------------"<<endl;
	*/
	}while(/**/!not_changed(classes,old_classes)/**//*false*/);
